...
naoBtn.addEventListener("mouseover", () => {
  attempts++;
  if (attempts >= 5) {
    mensagem.innerText = "Não adianta mentir, eu sei da verdade";
  }
...
simBtn.addEventListener("click", function(){
  mensagem.innerText = "uma musica para lembrar de mim e matar a saudade....";
  setTimeout(() => {
    window.location.href = "https://www.yout-ube.com/watch?v=PkPHDd9O9Yg"; // Coloque o link do vídeo desejado aqui
  }, 2000);
});
